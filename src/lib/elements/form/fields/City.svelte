<script lang="ts">
	...
	import LanguageSelect from '../../../../routes/dashboard/elements/selects/Language.svelte';
	import AddButton from '../../../../routes/dashboard/elements/AddButton.svelte';
	import RemoveButton from '../../../../routes/dashboard/elements/RemoveButton.svelte';
