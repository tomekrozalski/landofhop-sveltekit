<script lang="ts">
	...
	import ContainerTypeSelect from '../elements/selects/container/Type.svelte';
	import ContainerMaterialSelect from '../elements/selects/container/Material.svelte';
	import ContainerColorSelect from '../elements/selects/container/Color.svelte';
	import ContainerUnitSelect from '../elements/selects/container/Unit.svelte';
