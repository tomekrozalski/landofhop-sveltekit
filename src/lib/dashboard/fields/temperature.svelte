<script lang="ts">
	...
	import TemperatureUnitSelect from '$lib/dashboard/elements/selects/temperature.svelte';
	import { emptyTemperature, getNullishObject } from '$lib/dashboard/utils/emptyFieldValues';
