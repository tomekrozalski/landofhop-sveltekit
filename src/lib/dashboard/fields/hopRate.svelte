<script lang="ts">
	...
	import HopRateUnitSelect from '$lib/dashboard/elements/selects/hopRateUnit.svelte';
	import { emptyHopRate, getNullishObject } from '$lib/dashboard/utils/emptyFieldValues';
