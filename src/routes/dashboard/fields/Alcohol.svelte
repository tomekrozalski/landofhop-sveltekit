<script lang="ts">
	...
	import AlcoholRelateSelect from '../elements/selects/alcohol/Relate.svelte';
	import AlcoholScopeSelect from '../elements/selects/alcohol/Scope.svelte';
	import AlcoholUnitSelect from '../elements/selects/alcohol/Unit.svelte';
